...
- Updated Portals In/Out Behavior, Performance and Visuals - e.g. No render delay; Projectiles and Physics objects now pass through Portals. (the only exceptions being Railgun, Lightning Gun and Shotgun Projectiles for now)
