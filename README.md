...
FPS mechanics to match our good and old-fashioned Quake movement, on Unreal Engine. This Pack includes 3 Characters with distinct movements (defined as VQ3, QW and CPMA), a reimagined DM20 Map, plus a smaller one for you to make all your testing and much more.<br><br>
...
<h3>DEMO ./preview:</h3>
<a href="http://bit.ly/2Nb5k40">Kosm-DEMO (html5)</a><br>
<h3>DEMO ./download:</h3>
Check our <a href="https://github.com/vtx-factory/Kosm-FPS-Movement-Pack/releases">Releases</a> section to download the binaries for your platform. <strong>(or clone this git if you want the html5 version [you will have to host it in your own webserver])</strong><br><br><br>
<h1>Kosm-PACK</h1>
