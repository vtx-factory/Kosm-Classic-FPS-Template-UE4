...
**We're aware of the issues presented in the available build, where you can't open the project on the latest Unreal Engine version - we've issued a new updated build but its still pending approval from the Unreal Team, please give them some time to approve the changes, maximum until Wednesday, 11th of March. Sorry for any inconvenience.**
