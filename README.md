...
- Added Double Jump Selection Mode - DoubleJump Active, DoubleJump Disabled and Infinite DoubleJump. VQ3 Character will BeginPlay with DoubleJump Disabled for a better Bunny-hop demonstration.
- <i>(...)</i><br>
</details>
<details>
