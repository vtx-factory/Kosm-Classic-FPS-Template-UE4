...
<details>
  <summary><i><strong>(In Development)</strong></i> v0.6 <strong><i>- ETA: June/July, 2020</i></strong> </summary>
...
- Updated Portals In/Out Behavior, Performance and Visuals - e.g. No render delay; Physic Objects and Projectiles (not all of them) now pass through Portals.
...
- [ ] <strong>PORTALS:</strong> There's Mesh Clipping when passing through Portals. Machine Gun, Railgun, Lightning Gun and Shotgun Projectiles won't pass through them.
